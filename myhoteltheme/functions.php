<?php
// ✅ Load Navwalker trước mọi thứ để tránh lỗi "class not found"
require_once get_template_directory() . '/inc/class-wp-bootstrap-navwalker.php';

/**
 * myhoteltheme functions and definitions
 *
...
function myhoteltheme_setup() {
	/*
		...
		* If you're building a theme based on myhoteltheme, use a find and replace
		* to change 'myhoteltheme' to the name of your theme in all the template files.
		*/
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'myhoteltheme_custom_background_args',
			array(
...
function myhoteltheme_scripts() {
	wp_enqueue_style( 'myhoteltheme-style', get_stylesheet_uri(), array(), _S_VERSION );
	...
	wp_enqueue_script( 'myhoteltheme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
